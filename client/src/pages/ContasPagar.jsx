...
export default function ContasPagar() {
  ...
  const carregar = useCallback(async () => {
    ...
    try {
      const res = await fetch(apiUrl(`/api/financeiro/despesas?${params}`));
  ...
  return (
    <div
      ...
      data-testid="page-financeiro-contas-pagar"
    >
      ...
      <div className="px-8 py-4 bg-white border-b border-slate-200 flex items-center gap-4 flex-wrap">
        ...
        >
          ...
          {["estoque", "aluguel", "salario", "servico", "outros"].map((c) => (
