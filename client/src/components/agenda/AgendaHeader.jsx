  ...
  return (
    <header className="bg-white border-b border-slate-200 px-6 py-4">
      <div className="flex items-start justify-between gap-4 mb-4">
        <div>
          <p className="text-xs text-slate-400 mb-1">Clínicas &gt; Agenda</p>
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="flex-1 min-w-[200px] max-w-md relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-medical-600/30 focus:border-medical-600"
          />
        </div>
        ...
        <div className="relative flex" ref={dropdownRef}>
          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-full mt-1 w-48 bg-white border border-slate-200 rounded-lg shadow-lg z-40 py-1">
              <button
                type="button"
                onClick={() => { setDropdownOpen(false); onNewBloqueio(); }}
